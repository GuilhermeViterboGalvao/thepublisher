...
<style class="text/css">
	...
	.confirm-password-form input[type="password"] { float: left; width: 98%; border: 0.01em solid #000; padding: 1%; margin: 0 0 1.5% 0; }
	.confirm-password-form input[type="submit"] { float: left; width: 100%; padding: 1%; background-color: #fff; font-size: 1em; line-height: 1.2em; text-align: center; font-weight: 800; color: #414142; border: 0.01em solid #414142; }
