...
<s:set var="customHeaderImagePath" value="'/skins/tatame/special-categories/2016/grand-slam-rj/img/banner-top.jpg'" />

<s:if test="model != null && model instanceof com.publisher.entity.Article">
	<s:set var="customDfpPathJSP" value="'/skins/tatame/special-categories/2016/grand-slam-rj/google-dfp-script.jsp'" />
</s:if>
