...
<s:set var="customHeaderImagePath" value="'/skins/tatame/special-categories/2016/abu-dhabi/img/banner-top.jpg'" />

<s:if test="model != null && model instanceof com.publisher.entity.Article">
	<s:set var="customDfpPathJSP" value="'/skins/tatame/special-categories/2016/abu-dhabi/google-dfp-script.jsp'" />
</s:if>
