...
<nav class="ym-hlist">
	<ul>
		<li class="active">
			<strong>Contratos de Academias</strong>
		</li>
		<li class="active">
			<a href="contracts_gym-edit">Novo</a>
		</li>
	</ul>
...
<table class="list">
	<thead>
		<tr>
			<th>
				<a href="contracts_gym-list?orderBy=id&orderly=<s:property value="!orderly"/>">id</a>
			</th>
			<th>
				<a href="contracts_gym-list?orderBy=name&orderly=<s:property value="!orderly"/>">nome</a>
			</th>
			<th>
				<a href="contracts_gym-list?orderBy=start&orderly=<s:property value="!orderly"/>">data de inicio</a>
			</th>
			<th>
				<a href="contracts_gym-list?orderBy=end&orderly=<s:property value="!orderly"/>">data de fim</a>
			</th>
			<th></th>
		</tr>
	</thead>
	<tbody>
		<s:iterator value="list">
			<tr>
				...
				<td class="td">
					<a href="contracts_gym-edit?id=<s:property value="id"/>">Editar</a>
				</td>
			</tr>
		</s:iterator>
	</tbody>
...
<s:div cssClass="ym-grid" cssStyle='padding-top: 10px; margin-left: 10px; width: 98.8%;'> 
	<s:if test="currentPage > 1">
	    <s:url id="url" action="contracts_gym-list">
