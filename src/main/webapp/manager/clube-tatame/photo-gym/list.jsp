...
<link href="/manager/clube-tatame/photo-gym/css/list.css" type="text/css" rel="stylesheet"/>
<nav class="ym-hlist">
	<ul>
		<li class="active"><strong>Fotos</strong></li>
		<li><a href="photoGym-edit">Nova foto</a></li>
		<li><a href="photoGymMulti-add">Enviar várias fotos</a></li>		
	</ul>
...
<div id="photos" style="margin: 10px;">
    ...
    <s:iterator value="list">    
        <s:url id="url" action="photoGym-edit">
...
<s:div cssClass="ym-grid" cssStyle='padding-top: 10px; margin-left: 10px; width: 98.8%;'> 
	<s:if test="currentPage > 1">
	    <s:url id="url" action="photoGym-list">
