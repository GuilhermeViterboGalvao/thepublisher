...
<link href="/manager/clube-tatame/photo-gym/css/input.css" type="text/css" rel="stylesheet"/>
<nav class="ym-hlist">
	<ul>
		<li class="active">
...
<div style="margin-top: 5px;">
    ...
    <s:form method="post" enctype="multipart/form-data" action="photoGym-save" cssClass="ym-form"  accept-charset="UTF-8">     			
...
<script src="/manager/clube-tatame/photo-gym/js/input.js" type="text/javascript"></script>
