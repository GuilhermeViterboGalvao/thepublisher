...
<table class="list">
	<thead>
		<tr>
			<th>
				<a href="skin-list?orderBy=id&orderly=<s:property value="!orderly"/>">id</a>
			</th>
			<th>
				<a href="skin-list?orderBy=name&orderly=<s:property value="!orderly"/>">nome</a>
			</th>
			<th>
