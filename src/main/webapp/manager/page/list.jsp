...
<nav class="ym-hlist">
	<ul>
		<li class="active">
			<strong>Outras Capas</strong>
		</li>
		<li>
			<a href="page-edit">Adicionar</a>
		</li>		
	</ul>
...
<table class="list">
	<thead>
		<tr>
			<th>
				<a href="page-list?orderBy=id&orderly=<s:property value="!orderly"/>">id</a>
			</th>
			<th>
				<a href="page-list?orderBy=name&orderly=<s:property value="!orderly"/>">nome</a>
			</th>
			<th>
				<a href="page-list?orderBy=contentFile&orderly=<s:property value="!orderly"/>">arquivo</a>
			</th>
			<th></th>
		</tr>
	</thead>
